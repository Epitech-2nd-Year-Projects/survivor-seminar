...
func RegisterEvents(r *gin.RouterGroup, cfg *config.Config, db *gorm.DB, logger *logrus.Logger, uploader s3.Uploader) {
	h := v1handlers.NewEventsHandler(logger, db, uploader)
